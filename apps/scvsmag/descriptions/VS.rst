The Virtual Seismologist in SeisComP (VS(SC3)) provides near instantaneous
...
License for SeisComP Contributions' <http://www.seismo.ethz.ch/static/seiscomp_contrib/license.txt>`_.
